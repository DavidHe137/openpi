#!/bin/bash
#SBATCH --job-name=legos_30hz_finetune
#SBATCH --output=/coc/flash7/rbansal66/vvla/openpi-training/scripts/bash/log/legos_30hz_finetune.out
#SBATCH --error=/coc/flash7/rbansal66/vvla/openpi-training/scripts/bash/log/legos_30hz_finetune.err
...
uv run scripts/compute_norm_stats.py --config-name=pi05_legos_30hz
uv run scripts/train.py pi05_legos_30hz --exp-name=legos_30hz_finetune --fsdp-devices 4 --resume