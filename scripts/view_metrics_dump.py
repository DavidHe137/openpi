...
Point it at an experiment output directory and get
...
def main(args: Args) -> None:
    ...
    mock_store = MetricsStore.from_json(path / "server_metrics_history.json")
    metadata = ServerMetadata.from_json(path / "server_metadata.json")
