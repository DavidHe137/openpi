...
python examples/libero/main_parallel.py --args.task-suite-name libero_10 --args.num-workers=6 --args.num-trials-per-task=10 --args.experiment-name=replan_steps_$REPLAN_STEPS --args.replan_steps=$REPLAN_STEPS
