...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_train_rtc",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False, max_delay=5),
        data=LeRobotLiberoDataConfig(
            repo_id="physical-intelligence/libero",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_libero_train_rtc_low_mem",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
    ...
    TrainConfig(
        ...
        optimizer=_optimizer.AdamW(clip_gradient_norm=1.0),
        ema_decay=0.999,
        weight_loader=weight_loaders.CheckpointWeightLoader("/coc/cedarp-dxu345-0/rbansal66/openpi_checkpoints/pi05_legos_turntable_25hz_act100/legos_turntable_25hz_finetune_act100/29999/params"),
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_act100",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False),
        data=LeRobotLiberoDataConfig(
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_act100_finetune",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False),
        data=LeRobotLiberoDataConfig(
            repo_id="solace222/wall-maintenance-30hz",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
        ...
        optimizer=_optimizer.AdamW(clip_gradient_norm=1.0),
        ema_decay=0.999,
        weight_loader=weight_loaders.CheckpointWeightLoader("/coc/cedarp-dxu345-0/rbansal66/openpi_checkpoints/pi05_legos_turntable_better_full_30hz_act100/legos_turntable_30hz_finetune_act100_better_full/50000/params"),
        num_train_steps=10000,
        checkpoint_base_dir="/coc/cedarp-dxu345-0/rbansal66/openpi_checkpoints",
    ),
    #
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, max_delay=5),
        data=LeRobotLiberoDataConfig(
            repo_id="solace222/legos_turntable_new_30hz",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=20, discrete_state_input=False, max_delay=5),
        data=LeRobotLiberoDataConfig(
            repo_id="solace222/legos_turntable_new_30hz",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_rtc_act100_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=100,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_rtc_act20_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=20,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_rtc_act100_lora_d15",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=100,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_legos_turntable_better_full_30hz_rtc_act20_lora_d15",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=20,
            discrete_state_input=False,
