#!/bin/bash
#SBATCH --job-name=libero90_lora_fsdp_prompt
#SBATCH --output=/coc/flash7/zhenyang/logs/sbatch_out/openpi/libero90_lora_fsdp_prompt.out
#SBATCH --error=/coc/flash7/zhenyang/logs/sbatch_err/openpi/libero90_lora_fsdp_prompt.err
...
uv run scripts/train.py \
    ...
    --exp-name=libero90_lora_reasoning_prompt \
    --fsdp-devices=8 \
    --batch-size=256 \
    --overwrite